...
CREATE OR REPLACE TABLE LOGISTICS_DEMO.MONITORING.OBS_KPIS_DAILY (
    REPORT_DATE DATE,
    ...
    TOTAL_UNITS_REPLENISHED NUMBER,
    STOCK_TURNOVER_RATIO NUMBER(10, 2)
);

INSERT INTO LOGISTICS_DEMO.MONITORING.OBS_KPIS_DAILY (
    REPORT_DATE,
    WAREHOUSE_NAME,
    PRODUCT_NAME,
    CATEGORY,
...
VALUES
    (CURRENT_DATE - 1, 'Central DC', 'Demo Widget', 'Demo', 125, 118, 130, 0.91),
    (CURRENT_DATE - 1, 'East DC', 'Demo Gizmo', 'Demo', 80, 75, 90, 0.83);

CREATE OR REPLACE TABLE LOGISTICS_DEMO.MONITORING.OBS_KPIS_7D (
    LAST_DATE DATE,
    WK_ORDERS NUMBER,
    WK_UNITS NUMBER,
    AVG_TURNOVER NUMBER(10, 2)
);

INSERT INTO LOGISTICS_DEMO.MONITORING.OBS_KPIS_7D (
    LAST_DATE,
    WK_ORDERS,
    WK_UNITS,
    AVG_TURNOVER
)
VALUES (CURRENT_DATE - 1, 900, 860, 0.88);

CREATE OR REPLACE TABLE LOGISTICS_DEMO.MONITORING.OBS_FRESHNESS (
    AS_OF_DATE DATE,
    LATEST_MOVEMENT_DATE DATE,
    FRESHNESS_HOURS NUMBER
);

INSERT INTO LOGISTICS_DEMO.MONITORING.OBS_FRESHNESS (
    AS_OF_DATE,
    LATEST_MOVEMENT_DATE,
    FRESHNESS_HOURS
)
VALUES (CURRENT_DATE, CURRENT_DATE - 1, 12);